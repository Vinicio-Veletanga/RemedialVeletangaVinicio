...
a persistence unit "RemedialVeletangaVinicioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "RemedialVeletangaVinicio\pom.xml":
...
artifact ("RemedialVeletangaVinicio.war") is already built. You can build
